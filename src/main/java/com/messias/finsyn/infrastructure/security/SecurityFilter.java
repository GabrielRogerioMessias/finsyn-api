...
public class SecurityFilter extends OncePerRequestFilter {
    ...
    public SecurityFilter(TokenService tokenService, JpaUsuarioRepository jpaUsuarioRepository) {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (login != null) {
            JpaUsuarioEntity jpaUsuarioEntity = jpaUsuarioRepository.findByEmail(login).orElseThrow(() -> new RuntimeException("Usuário não encontrado."));
