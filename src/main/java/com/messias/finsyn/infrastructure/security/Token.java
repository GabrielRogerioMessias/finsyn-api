...
public class Token {
    ...
    @Schema(description = "Hora em que o token foi criado", example = "2025-07-22T00:36:25.794+00:00")
    private Date created;
    @Schema(description = "Hora de expiração do token", example = "2025-07-22T02:36:25.794+00:00")
